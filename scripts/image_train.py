...
def main():
    ...
    train_dataset = Cine2LGEDataset(
        '/mnt/data_2/qijingothers2/AMI_ddpm/data_excel/data_PLA_npz_train.csv',
        '/mnt/data_2/qijingothers2/MI_ddpm/data_image/', True, img_size=args.image_size)
